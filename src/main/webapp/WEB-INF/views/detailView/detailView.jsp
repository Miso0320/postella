...
<body>
	...
	<main id="contents" class="contents_product"> <!-- 상품 상세페이지 윗부분 -->
	<div class="prod-btop">
				...
				<div class="prod-image-container">
					<ul class="thum-list">
						<c:forEach var="thmImg" items="${thmImgs}">
							<li class="prod-image__item"><img class="thum-list-img" src="data:${thmImg.img_type};base64, ${thmImg.encodedFile}" alt="썸네일 리스트"></li>
						</c:forEach>
					</ul>
					<div class="thumbnail-container">
						<div class="thumbnail-wrapper">
							<img class="thumbnail_img" src="data:${thumnail.img_type};base64, ${thumnail.encodedFile}" alt="썸네일"> <span class="inner-frame"></span>
						</div>
					</div>
			...
			<div class="prod-top-right-detail">
				<div class="prod-buy-header">
					<div class="title-star-rev">
						...
						<div class="prod-header-star-rev">
							<span class="rating-star"> <img alt="별점5" src="${pageContext.request.contextPath}/resources/img/detailView/star5.png">
					...
					<div class="like-share-btn">
						...
						<div class="prod-share">
							...
							<div class="prod-share-layer" id="prod-share-layer">
								<ul>
									<li class="prod-share__item"><img class="share_mini_img" alt="트위터" src="${pageContext.request.contextPath}/resources/img/detailView/twitter.png"></li>
									<li class="prod-share__item"><img class="share_mini_img" alt="메일" src="${pageContext.request.contextPath}/resources/img/detailView/mail.png"></li>
									<li class="prod-share__item"><img class="share_mini_fb" alt="페북" src="${pageContext.request.contextPath}/resources/img/detailView/good.png"></li>
								</ul>
				...
				<div class="prod-price-container">
					<div class="prod-origin-price">
						<span class="disrev-cnt-rate" style="font-size: 14px; color: #cb1400;">${intSalePercent}%</span> <a class="origin-price" href="#"> <span id="basic-price">${TopPrdPrice}</span> <span>원</span> <img alt="워닝" src="${pageContext.request.contextPath}/resources/img/detailView/warning.png" style="width: 14px; height: 14px;" />
						</a>
					</div>

					<div class="prod-coupang-price">
						<span class="total-price" style="color: #768695;"> <strong id="cou-price">8900</strong> <strong>원</strong>
						</span> <span class="price-krtext" style="color: #768695;">쿠팡판매가</span>

						<div class="prod-coupon-price price-align major-price-coupon">
							<span class="total-price" style="color: #cb1400;"> <strong id="final-price">${TopPrdSaleprice}</strong> <strong>원</strong>

							</span> <span class="price-krtext" style="color: #cb1400;">즉시할인가</span> </span> <span class="price-krtext" style="color: #cb1400;">포스텔라 할인가</span>
						</div>

						<div class="reward-badge" style="padding-left: 5px;">
							<!-- 미소 - img 태그의 margin-bottom 속성이 수정됐어요! -->
							<img class="reward-cash-ico" alt="코인" src="${pageContext.request.contextPath}/resources/img/detailView/coin.png" style="width: 14px; margin-bottom: 5px;"><span class="reward-cash-txt" style="padding-left: 5px;">최대 ${point}원 적립</span>
						</div>
					</div>
					...
					<div class="prod-top-shipping-fee">
						<div class="prod-shipping-fee-message">
							<span> <em class="shipping-text" style="font-weight: bold; font-style: normal;">무료배송</em> <em class="shipping-condition" style="font-style: normal;">(같은 판매자 상품 50,000원 이상 구매 시)</em></span>
						</div>

						<div class="prod-arrival-container">
							<em class="arrival-day" style="font-style: normal;">${deliverDay}</em> <em class="arrival-text" style="font-style: normal;"> 도착 예정</em>
						</div>
					</div>

					<div class="prod-vendor-container">
						<div class="vendor-name">
							판매자: <a class="vendor-name-text" style="color: #346aff;" href="#"> <span>아기 고양이 </span> <img class="prod-seller-link-coach" alt="판매자" src="https://img1a.coupangcdn.com/image/dragonstone/sdp/new-coach-mark.png" style="height: 22px; margin-bottom: 5px">
							</a>
						</div>
						<div class="vendor-info">
							<div class="vendor-rating " style="padding-bottom: 10px;">
								<span class="vendor-rating-text">판매자 평가</span> <img class="vendor-rating-icon" alt="따봉" src="${pageContext.request.contextPath}/resources/img/detailView/ddabong.png" style="width: 14px; height: 14px;"> <span class="vendor-rating-score">96%</span> <span class="vendor-rating-cnt">(842)</span> <a class="vendor-info-warn" href="#"> <img alt="워닝" src="${pageContext.request.contextPath}/resources/img/detailView/warning.png" style="width: 14px; height: 14px;">
								</a>
							</div>
							...
							<div class="op_btn_left_right">
								<div class="op_btn_text">
									...
									<div class="op_btn_set">
										<span class="value " style="width: auto; padding: 2px;"> 01.Like It Carrot 라이크잇 캐롯 묶음 × 2세트 </span>
									</div>
								</div>
								<div class="op_btn_imgset">
									<span class="op_img"> <img class="thumbnail" id="op-thumbnai" alt="상품사진" src="${pageContext.request.contextPath}/resources/img/detailView/post_list2.PNG" style="width: 38px; height: 38px; padding-right: 2px" /> <img class="dropdown-icon" alt="아래화살표" src="${pageContext.request.contextPath}/resources/img/detailView/arrow_down.png" />
									</span>
								</div>
							</div>
						</button>
					...
					<div class="prod-reward-cash-container">
						<div class="reward-cash-summary">
							<img alt="coin" src="${pageContext.request.contextPath}/resources/img/detailView/coin.png" style="width: 20px;"> <strong class="reward-text">캐시적립 혜택</strong> <img class="reward-warn" alt="워닝" src="${pageContext.request.contextPath}/resources/img/detailView/warning.png" style="width: 14px"> <span class="reward-info"> <em class="separator" style="font-style: normal;">|</em> <em class="reward-info-txt" style="font-style: normal;"> 최대 <strong class="info-txt-fin">334</strong> 원 적립
							</em>
							</span>
						</div>
						...
						<div class="reward-promotion">
							...
							<p class="reward-promotion-item">
								[로켓와우 + 쿠페이 머니] 결제 시 4% 추가적립 <strong class="desc-amt">2일 남음</strong>
							</p>
					...
					<div class="prod-quantity-cart-buy">
						<div class="prod-quantity-form">
							<input type="text" value="1" class="prod-quantity-input" style="width: 60px;">
					...
					<div class="prod-description">
						<ul class="prod-description-list">
							<li class="prod-description-list-item" style="font-size: 12px; list-style: disc;">구성품: 30장 1세트</li>
							<li class="prod-description-list-item" style="font-size: 12px; list-style: disc;">사이즈: 10cm x 14cm</li>
							<li class="prod-description-list-item" style="font-size: 12px; list-style: disc;">메시지 종류: 사랑/고백</li>
							<li class="prod-description-list-item" style="font-size: 12px; list-style: disc;">쿠팡상품번호: 5683021782 - 9391285562</li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="prod-bbottom">
			<div id="recommendation-compare" class="recommendation">
				<div class="recommendation-header">
					...
					<span class="recommendation-header-ad"> 광고 <img class="recommendation-header-warn" alt="주의" src="${pageContext.request.contextPath}/resources/img/detailView/warning.png" style="width: 14px"></img>
					</span>
				</div>
						...
						<ul class="recommendation-list">
							<li><a href="img/p1.jpg">
									<div class="product">
										...
										<div class="rec-item-text">
											<strong class="rec-item-title">LAVERTON 인테리어 엽서 자석고리 골드(후크)+ 30장1세트+양면테이프(50개)+라운드스티커1개(랜덤) 포함</strong>>
										</div>
										<div class="rec-item-price">
											<span><em style="font-style: normal;">2,670</em>원</span>
										</div>
										<div class="rec-item-review">
											<input type="image" src="${pageContext.request.contextPath}/resources/img/detailView/star5.png" width="70px"> <span class="star-rating">(21)</span>
										</div>
									</div>
							</a></li>
							<li><a href="img/p2.jpg">
									<div class="product">
										...
										<div class="rec-item-review">
											<input type="image" src="${pageContext.request.contextPath}/resources/img/detailView/star4.png" width="70px"> <span class="star-rating">(15)</span>
										</div>
									</div>
							</a></li>
							<li><a href="img/p3.jpg">
									<div class="product">
										...
										<div class="rec-item-text">
											<strong class="rec-item-title">[비츨] 인테리어 빈티지 페이퍼 20종+원형스티커 세트 - 스카이블루 / 촬영소품 카페 감성 엽서 일러스트 벽장식</strong>
										</div>
										<div class="rec-item-price">
											<span><em style="font-style: normal;">9,900</em>원</span>
										</div>
										<div class="rec-item-review">
											<input type="image" src="${pageContext.request.contextPath}/resources/img/detailView/star5.png" width="70px"> <span class="star-rating">(12)</span>
										</div>
									</div>
							</a></li>
							<li><a href="img/p4.jpeg">
									<div class="product">
										...
										<div class="rec-item-text">
											<strong class="rec-item-title">알폰스무하 베르메르 뭉크 폴세잔 윈슬로호머 존싱어사전트 30장 엽서셋트 명화 엽서</strong>>
										</div>
										<div class="rec-item-price">
											<span><em style="font-style: normal;">6,670</em>원</span>
										</div>
										<div class="rec-item-review">
											<input type="image" src="${pageContext.request.contextPath}/resources/img/detailView/star4.png" width="70px"> <span class="star-rating">(21)</span>
										</div>
									</div>
							</a></li>
							<li><a href="img/p5.jpg">
									<div class="product">
										...
										<div class="rec-item-text">
											<strong class="rec-item-title">모노라이크 버스데이 파티 엽서 24종 세트</strong>
										</div>
										<div class="rec-item-price">
											<span><em style="font-style: normal;">4,900</em>원</span>
										</div>
										<div class="rec-item-review">
											<input type="image" src="${pageContext.request.contextPath}/resources/img/detailView/star5.png" width="70px"> <span class="star-rating">(11)</span>
										</div>
									</div>
							</a></li>
							<li><a href="img/p6.jpg">
									<div class="product">
										...
										<div class="rec-item-review">
											<input type="image" src="${pageContext.request.contextPath}/resources/img/detailView/star4.png" width="70px"> <span class="star-rating">(18)</span>
										</div>
									</div>
							</a></li>
							<li><a href="img/p6.jpg">
			...
			<div id="bprod_detail_all" class="prod_detail">
				...
				<div class="tab-contents">
					...
					<div class="warning-banner">
						<span class="warning-banner-icon"><img alt="워닝" src="${pageContext.request.contextPath}/resources/img/detailView/red_warning.png" style="height: 16px;"></span> <span class="warning-banner-txt"> 판매자가 현금거래를 요구하면 거부하시고 즉시 사기 거래 신고센터 (02-2621-4699)에 신고하시기 바랍니다. </span>
					</div>
					...
					<div class="product-detail-seemore" id="seemore-layer">
						<button class="product-detail-seemore-btn" id="seemore-btn">
							<span id="seemore-text">상품정보 더보기</span> <span id="seemore-arrow"></span>
						</button>
					</div>
					...
					<div class="review-list-container">
						...
						<section class="review-list-section1">
							...
							<div class="review-search">
								<input class="review-search-Input" type="text" placeholder="상품평을 검색해보세요." maxlength="30">
						...
						<section class="review-list-section2">
							<article class="review-article">
								<div class="review-article-info">
									<div class="review-article-info-top">
										<span class="review-writer-profile"> <img class="review-writer-profile-img" alt="" src="${pageContext.request.contextPath}/resources/img/detailView/profile.png">
										</span>
										<div class="review-name-star-date">
											...
											<div class="review-writer-content">
												<span class="review-content-star"> <img alt="" src="${pageContext.request.contextPath}/resources/img/detailView/star1.png" class="review-content-starimg">
							...
							<article class="review-article">
								<div class="review-article-info">
									<div class="review-article-info-top">
										...
										<div class="review-name-star-date">
											...
											<div class="review-writer-content">
												<span class="review-content-star"> <img alt="" src="${pageContext.request.contextPath}/resources/img/detailView/star4.png" class="review-content-starimg">
								...
								<div class="review-content-text">엽서에 저를 닮은 고양이가 있어서 너무 마음에 들어요!!</div>
								<div class="do-report">
									<button class="do-report-btn">신고하기</button>
								</div>
							</article>
					...
					<div id="recommendation-good" class="recommendation">
						<div class="recommendation-header">
							<div class="recommendation-header-title">
								<span class="recommendation-4points">4점 이상</span> <span class="recommendation-4points-text">리뷰가 좋은 상품</span>
							</div>
						</div>
						<div class="recommendation-inner">
							<ul class="recommendation-list">
					...
					<div class="prod-inquiry-list">
						...
						<div class="prod-inquiry-list-notice">
							<ul>
								<li>구매한 상품의 <em style="font-style: normal;">취소/반품은 마이쿠팡 구매내역에서 신청</em> 가능합니다.
								</li>
								<li>상품문의 및 후기게시판을 통해 취소나 환불, 반품 등은 처리되지 않습니다.</li>
								<li><em style="font-style: normal;">가격, 판매자, 교환/환불 및 배송 등 해당 상품 자체와 관련 없는 문의는 고객센터 내 1:1 문의하기</em>를 이용해주세요.</li>
								<li><em style="font-style: normal;">"해당 상품 자체"와 관계없는 글, 양도, 광고성, 욕설, 비방, 도배 등의 글은 예고 없이 이동, 노출제한, 삭제 등의 조치가 취해질 수 있습니다.</em></li>
						...
						<div class="prod-inquiry-qna">
							<div class="prod-inquiry-items">
								<div class="prod-inquiry-item">
									...
									<hr class="sep-line" />
									<div class="prod-inquiry-qpname-set">
										<img alt="" src="${pageContext.request.contextPath}/resources/img/detailView/pointer.png" style="width: 20px; height: 20px;"> <em class="prod-inquiry-item-a">답변</em>
										<div class="prod-inquiry-item-option">아기 고양이</div>
									</div>
									<div class="prod-inquiry-item-text">안녕하세요 아기고양이입니다. 재입고 안합니다.</div>
						...
						<div class="prod-report">
							...
							<a href="javascript:;" class="prod-report__button" id="productReport" title="신고하기">신고하기</a>
						</div>
					</div>
					<div class="etc-info-set" id="etc-info-set">
							...
							<table class="prod-delivery-return-policy-table">
								...
								<tbody>
									<tr>
										...
										<th rowspan="2">배송비</th>
										<td rowspan="2">3,000원<br>- 9,800원 이상 구매 시 무료배송<br>· 도서산간 추가 배송비<br>- 제주 지역: 4,000원<br>- 도서산간 지역: 4,000원
										</td>
									</tr>
									<tr>
										<th>배송사</th>
									...
									<tr class="return-policy-optional-info" style="">
										<th>배송기간</th>
										<td colspan="3">ㆍ도서산간 지역 등은 배송에 3-5일이 더 소요될 수 있습니다.<br> &nbsp;&nbsp;- 천재지변, 물량 수급 변동 등 예외적인 사유 발생 시, 다소 지연될 수 있는 점 양해 부탁드립니다.
										</td>
									</tr>
								</tbody>
							</table>
						...
						<div class="etc-info-group">
							...
							<ul class="prod-delivery-return-policy-legal-notice">
								<li>ㆍ교환/반품에 관한 일반적인 사항은 판매자가 제시사항보다 관계법령이 우선합니다. <br>다만, 판매자의 제시사항이 관계법령보다 소비자에게 유리한 경우에는 판매자 제시사항이 적용됩니다.
								</li>
							</ul>
							<table class="prod-delivery-return-policy-table">
								<colgroup>
								...
								<tbody>
									<tr>
										...
										<td>6,000원<br>- 단, 고객 변심의 경우에만 발생<br>- 도서산간 및 일부 지역 추가비용 발생<br>- 부분반품 시, 남은금액이 무료배송 조건을 유지하면 편도 배송비용만 부과
										</td>
									</tr>
									<tr>
										<th>교환/반품 신청 기준일</th>
										<td>
											<p>ㆍ단순변심에 의한 교환/반품은 제품 수령 후 7일 이내까지, 교환/반품 제한사항에 해당하지 않는 경우에만 가능 (배송비용과 교환/반품 비용 왕복배송비 고객부담)</p>
											<p>
												ㆍ상품의 내용이 표시·광고의 내용과 다른 경우에는 상품을 수령한 날부터 3개월 이내, 그 사실을 안 날 또는 알 수 있었던 날부터<br> <span class="prod-delivery-return-policy__limit-list__indent">30일 이내에 청약철회 가능</span>
											</p>
										</td>
									</tr>
								</tbody>
								...
								<tbody>
									...
									<tr>
										...
										<td>
											...
											<p>
												ㆍ뷰티 상품 이용 시 트러블(알러지, 붉은 반점, 가려움, 따가움)이 발생하는 경우,<br> <span class="prod-delivery-return-policy__limit-list__indent">진료 확인서 및 소견서 등을 증빙하면 환불이 가능 (제반비용 고객부담)</span>
											</p>
										</td>
									</tr>
									<tr>
						...
						<div class="etc-info-group">
							...
							<div class="etc-info-group">
								<p class="prod-minor-notice">미성년자가 체결한 계약은 법정대리인이 동의하지 않는 경우 본인 또는 법정대리인이 취소할 수 있습니다. 쿠팡은 통신판매중개자로서 통신판매의 당사자가 아니며, 광고,&nbsp;고시정보, 상품 주문, 배송 및 환불의 의무와 책임은 각 판매자에 있습니다.</p>
							</div>
						</div>
					</div>
