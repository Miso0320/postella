               ...
               <div class="prod-image-container">
                  <ul class="thum-list">
                     <li class="prod-image__item">
                        <img class="thum-list-img" src="${pageContext.request.contextPath}/resources/img/detailView_img/detailView_img/post_thum.PNG" alt="홀로그램 엽서">
                     </li>

                     <li class="prod-image__item">
                        <img class="thum-list-img" src="${pageContext.request.contextPath}/resources/img/detailView_img/detailView_img/post_list1.PNG" alt="엽서리스트1">
                     </li>
                     <li class="prod-image__item">
                        <img class="thum-list-img" src="${pageContext.request.contextPath}/resources/img/detailView_img/detailView_img/post_list3.PNG" alt="엽서리스트1">
                     </li>
                  </ul>
                  <div class="thumbnail-container">
                     <div class="thumbnail-wrapper">
                        <img class="thumbnail_img" src="${pageContext.request.contextPath}/resources/img/detailView_img/detailView_img/post_thum.PNG" alt="홀로그램 엽서">
            ...
            <div class="prod-top-right-detail">
                  ...
                  <div class="title-star-rev">
                     ...
                     <div class="prod-header-star-rev">
                        <span class="rating-star"> <img alt="별점5"
                           src="${pageContext.request.contextPath}/resources/img/detailView_img/detailView_img/star5.png">
                        ...
                        <div class="prod-share-layer" id="prod-share-layer">
                            <ul>
                                <li class="prod-share__item">
                                   <img class="share_mini_img" alt="트위터" src="${pageContext.request.contextPath}/resources/img/detailView_img/detailView_img/twitter.png">
                                </li>
                                <li class="prod-share__item">
                                   <img class="share_mini_img" alt="메일" src="${pageContext.request.contextPath}/resources/img/detailView_img/detailView_img/mail.png">
                                </li>
                                <li class="prod-share__item">
                                   <img class="share_mini_fb" alt="페북" src="${pageContext.request.contextPath}/resources/img/detailView_img/detailView_img/good.png">
                                </li>
                            </ul>
               ...
               <div class="prod-price-container">
                  <div class="prod-origin-price">
                     ...
                     <a class="origin-price" href="#"> 
                        ...
                        <span>원</span>
                        <img alt="워닝" src="${pageContext.request.contextPath}/resources/img/detailView_img/detailView_img/warning.png" style="width: 14px; height: 14px;"/>
                     </a>
                  </div>
                  ...
                  <div class="reward-badge" style="padding-left: 5px;">
                     ...
                     <img class="reward-cash-ico" alt="코인" src="${pageContext.request.contextPath}/resources/img/detailView_img/detailView_img/coin.png"
                  ...
                  <div class="vendor-info">
                     <div class="vendor-rating " style="padding-bottom: 10px;">
                        <span class="vendor-rating-text">판매자 평가</span> <img
                           class="vendor-rating-icon" alt="따봉" src="${pageContext.request.contextPath}/resources/img/detailView_img/detailView_img/ddabong.png"
                           style="width: 14px; height: 14px;"> <span
                           class="vendor-rating-score">96%</span> <span
                           class="vendor-rating-cnt">(842)</span> <a
                           class="vendor-info-warn" href="#"> <img alt="워닝"
                           src="${pageContext.request.contextPath}/resources/img/detailView_img/detailView_img/warning.png" style="width: 14px; height: 14px;">
                        </a>
                     </div>
                  ...
                  <button class="prod-option-btn" id="prod-option-btn">
                     <div class="op_btn_left_right">
                        ...
                        <div class="op_btn_imgset">
                           <span class="op_img"> 
                                 <img class="thumbnail" id="op-thumbnai" alt="상품사진" src="${pageContext.request.contextPath}/resources/img/detailView_img/detailView_img/post_list2.PNG" style="width: 38px; height: 38px; padding-right: 2px"/>
                                 <img class="dropdown-icon" alt="아래화살표" src="${pageContext.request.contextPath}/resources/img/detailView_img/detailView_img/header/arrow_down.png"/>
                           </span>
                        </div>
                     </div>
                  </button>
                  <div class="op-btn-list" id="op-btn-list">
                     <a class="op-list-content" id="op1">
                        <div class="prod-option-dropdown-item-left">
                                     <img src="${pageContext.request.contextPath}/resources/img/detailView_img/detailView_img/p2.jpg" width="38px" height="38px">
                                 </div>
                     ...
                     <a class="op-list-content" id="op2">
                        <div class="prod-option-dropdown-item-left">
                                     <img src="${pageContext.request.contextPath}/resources/img/detailView_img/detailView_img/p6.jpg" width="38px" height="38px">
                                 </div>
                               <div class="prod-option-dropdown-item-right">
                     ...
                     <a class="op-list-content" id="op3">
                        <div class="prod-option-dropdown-item-left">
                                     <img src="${pageContext.request.contextPath}/resources/img/detailView_img/detailView_img/p1.jpg" width="38px" height="38px">
                                 </div>
                               <div class="prod-option-dropdown-item-right">
                     ...
                     <a class="op-list-content" id="op4">
                        <div class="prod-option-dropdown-item-left">
                                     <img src="${pageContext.request.contextPath}/resources/img/detailView_img/detailView_img/p5.jpg" width="38px" height="38px">
                                 </div>
                               <div class="prod-option-dropdown-item-right">
               ...
               <div class="prod-reward-cash-container">
                  <div class="reward-cash-summary">
                     <img alt="coin" src="${pageContext.request.contextPath}/resources/img/detailView_img/detailView_img/coin.png" style="width: 20px;"> <strong
                        class="reward-text">캐시적립 혜택</strong> <img class="reward-warn"
                        alt="워닝" src="${pageContext.request.contextPath}/resources/img/detailView_img/detailView_img/warning.png" style="width: 14px"> <span
                  ...
                  <div class="prod-quantity-form">
                     ...
                     <div class="updown-btn">
                        <button class="prod-cnt-btn" id="cnt-plus" type="button">
                           <img alt="" src="${pageContext.request.contextPath}/resources/img/detailView_img/detailView_img/up.png">
                        </button>
                        <button class="prod-cnt-btn" id="cnt-minus" type="button">
                           <img alt="" src="${pageContext.request.contextPath}/resources/img/detailView_img/detailView_img/down.png">
                        </button>
                     </div>
                  </div>
         ...
         <div id="recommendation-compare" class="recommendation">
            <div class="recommendation-header">
               ...
               <span class="recommendation-header-ad"> 광고 <img
                  class="recommendation-header-warn" alt="주의" src="${pageContext.request.contextPath}/resources/img/detailView_img/detailView_img/warning.png"
               ...
               <div class="reco-btn" id="next"></div>
                  <ul class="recommendation-list">
                     <li><a href="img/p1.jpg">
                           <div class="product">
                              <div class="img">
                                 <img class="rec-item-image" src="${pageContext.request.contextPath}/resources/img/detailView_img/detailView_img/p1.jpg" alt="엽서1">
                              </div>
                              ...
                              <div class="rec-item-review">
                                 <input type="image" src="${pageContext.request.contextPath}/resources/img/detailView_img/detailView_img/star5.png" width="70px">
                     ...
                     <li><a href="img/p2.jpg">
                           <div class="product">
                              <div class="img">
                                 <img class="rec-item-image" src="${pageContext.request.contextPath}/resources/img/detailView_img/detailView_img/p2.jpg" alt="엽서2">
                              </div>
                              <div class="rec-item-text">
                              ...
                              <div class="rec-item-review">
                                 <input type="image" src="${pageContext.request.contextPath}/resources/img/detailView_img/detailView_img/star4.png" width="70px">
                     ...
                     <li><a href="img/p3.jpg">
                           <div class="product">
                              <div class="img">
                                 <img class="rec-item-image" src="${pageContext.request.contextPath}/resources/img/detailView_img/detailView_img/p3.jpg" alt="엽서3">
                              </div>
                              <div class="rec-item-text">
                     ...
                     <li><a href="img/p4.jpeg">
                           <div class="product">
                              <div class="img">
                                 <img class="rec-item-image" src="${pageContext.request.contextPath}/resources/img/detailView_img/detailView_img/p4.jpeg" alt="엽서4">
                              </div>
                              <div class="rec-item-text">
                     ...
                     <li><a href="img/p5.jpg">
                           <div class="product">
                              <div class="img">
                                 <img class="rec-item-image" src="${pageContext.request.contextPath}/resources/img/detailView_img/detailView_img/p5.jpg" alt="엽서5">
                              </div>
                              <div class="rec-item-text">
                     ...
                     <li><a href="img/p6.jpg">
                           <div class="product">
                              <div class="img">
                                 <img class="rec-item-image" src="${pageContext.request.contextPath}/resources/img/detailView_img/detailView_img/p6.jpg" alt="엽서6">
                              </div>
                              <div class="rec-item-text">
                     ...
                     <li><a href="img/p6.jpg">
                           <div class="product">
                              <div class="img">
                                 <img class="rec-item-image" src="${pageContext.request.contextPath}/resources/img/detailView_img/detailView_img/post_list1.PNG" alt="엽서7">
                              </div>
                              <div class="rec-item-text">
                                 <strong class="rec-item-title">열두진주문 칭찬카드 100매</strong>
                              </div>
                     ...
                     <li><a href="img/p6.jpg">
                           <div class="product">
                              <div class="img">
                                 <img class="rec-item-image" src="${pageContext.request.contextPath}/resources/img/detailView_img/detailView_img/post_list3.PNG" alt="엽서8">
                              </div>
                              <div class="rec-item-text">
                                 <strong class="rec-item-title">열두진주문 칭찬카드 100매</strong>
                              </div>
            ...
            <div class="tab-contents">
               ...
               <div class="warning-banner">
                  <span class="warning-banner-icon"><img alt="워닝"
                     src="${pageContext.request.contextPath}/resources/img/detailView_img/detailView_img/red_warning.png" style="height: 16px;"></span> <span
               ...
               <div class="prod-detail-aco show-preview" id="prod-detail-aco">
                  <div class="prod-detail-img">
                     <img alt="상세정보" src="${pageContext.request.contextPath}/resources/img/detailView_img/detailView_img/prod_detail.jpg">
                  </div>
                  ...
                  <div class="review-tab-container" id="review-tab-container">
                     ...
                     <div class="review-info-starset">
                        <div class="review-info-starimg">
                           <img alt="별점" src="${pageContext.request.contextPath}/resources/img/detailView_img/detailView_img/star5.png" style="width: 245px;">
                        </div>
                        ...
                        <div class="review-article-info">
                           <div class="review-article-info-top">
                              <span class="review-writer-profile"> <img
                                 ...
                                 src="${pageContext.request.contextPath}/resources/img/detailView_img/detailView_img/profile.png">
                              </span>
                              <div class="review-name-star-date">
                                 ...
                                 <div class="review-writer-content">
                                    <span class="review-content-star"> <img alt=""
                                       src="${pageContext.request.contextPath}/resources/img/detailView_img/detailView_img/star1.png" class="review-content-starimg">
                        ...
                        <div class="review-article-info">
                           <div class="review-article-info-top">
                              ...
                              <div class="review-name-star-date">
                                 ...
                                 <div class="review-writer-content">
                                    <span class="review-content-star"> <img alt=""
                                       src="${pageContext.request.contextPath}/resources/img/detailView_img/detailView_img/star4.png" class="review-content-starimg">
                  ...
                  <div class="prod-inquiry-qna">
                     <div class="prod-inquiry-items">
                        <div class="prod-inquiry-item">
                           ...
                           <hr class="sep-line" />
                           <div class="prod-inquiry-qpname-set">
                              <img alt="" src="${pageContext.request.contextPath}/resources/img/detailView_img/detailView_img/pointer.png"
