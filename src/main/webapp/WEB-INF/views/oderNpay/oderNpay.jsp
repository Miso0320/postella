...
<head>
	...
	<link rel="stylesheet" href="oderNpay.css">
				...
				<tbody>
					<tr class="payOrder-wrap">
						...
						<td>
							<div class="payOrder">
								<strong class="price">
			                    	<span id="totalPriceDisp" class="use-calculation-for-totalprice">19900</span>
					...
					<tr>
						...
						<td>
							<div class="price" id="disc-coupon"><strong><span>0</span><span>원</span></strong></div>
					...
					<tr>
						...
						<td class="delivery-total-price">
							<div class="price"><strong><span>0</span><span>원</span></strong></div>
						</td>
					</tr>
					<tr class="payCoupangCash">
						<th class="wrap-title" scope="row">쿠팡캐시</th>
						<td>
							<div class="price"><strong><span>0원</span></strong></div>
							<div class="selected-coupon">
								<span class="usable">보유 : <strong><span>0</span><span>원</span></span>
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class="payPrice"><strong><span>0</span><span>원</span></strong></div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class="select-pay">
								<ul id="payTypeList" class="type-selector-list">
						            ...
						            <li id="rocketPayBalanceBox" class="type-selector-li">
						                <input class="type-selector-radio" type="radio" name="payType" id="payType9" value="BALANCE">
						                <label class="type-selector-label type-selector-label--balance" for="payType9" style="font-weight: normal;">
					                ...
					                <li id="cardPayBox" class="type-selector-li">
					                    <input class="type-selector-radio" type="radio" name="payType" id="payType1" value="B-CARD">
							...
							<div class="rocketpay-payment pay-type-content" id="coupay">
								<ul class="pay-type-sections">
									...
									<li class="pay-type-section last-section balance-sufficient">
										<div class="line-note">* 잔액이 부족할 경우, 결제 진행 시에 충전됩니다.</div>
									</li>
								</ul>
							</div>
