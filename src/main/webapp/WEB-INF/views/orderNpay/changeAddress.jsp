				...
				<c:forEach var="da" items="${daList}">
					<div class="address-card">
						...
						<div class="address-card__body">
							<div class="address-card__text address-card__text--address">${da.da_adr} ${da.da_detail_adr}</div>
							<div class="address-card__text address-card__text--cellphone">${da.da_tel}</div>
