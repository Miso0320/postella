							...
							<td class="customer__col customer__col--2">
								<div data-component="customer-phone">
									<div class="customer-phone__root">
										...
										<div>
											<p class="customer-phone__noti">* 인증 번호를 못 받았다면, 1577-7011 번호 차단 및 스팸 설정을 확인해 주세요.</p>
										</div>
										<div class="customer-phone-auth__root">
											<p class="customer-phone-auth__noti ">입력하신 휴대폰 번호로 인증번호가 발송 되었습니다.</p>
											<div class="customer-phone-auth__form">
												<form data-customer-phone--form-auth="">
													<div>
														<input type="tel" class="customer-phone-auth__input " data-customer-phone--input-auth="" value="">
														<button type="submit" class="customer-phone__submit">인증완료</button>
													</div>
												</form>
											</div>
										</div>
					...
					<div class="bundle-info__item-list ">
						<c:forEach var="product" items="${products}">
							<div class="bundle-info__vendor-item-box ">
								...
								<div class="pricePerOption">
									<span class="op-price">${product.prd_price * product.quantity}</span><span>원</span>
								</div>
							</div>
						</c:forEach>
					</div>
			...
			<table class="pay-price">
				<tbody>
					<tr class="payOrder-wrap">
						...
						<td>
							<div class="payOrder">
								<strong class="price"> <span id="totalPriceDisp" class="use-calculation-for-totalprice op-price">${totalPrice}</span> <span
									class="unit"
								>원</span>
								</strong>
							</div>
					...
					<tr>
						...
						<td class="delivery-total-price">
							<div class="price">
								<strong><span class="op-price" id="shipFee">${shippingFee}</span><span>원</span></strong>
							</div>
						</td>
					</tr>
					<tr class="payCoupangCash">
						...
						<td>
							<div class="price">
								<strong><input id="pointInput" class="op-price" onchange="inputPoint()" value="0" /><span>원</span></strong>
							</div>
					...
					<tr>
						...
						<td>
							<div class="payPrice">
								<strong><span class="op-price" id="totalPayPrice">${totalPrice + shippingFee}</span><span>원</span></strong>
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							...
							<div class="pay-type-content" id="bank" style="display: block;">
								<ul class="pay-type-sections">
									<li class="pay-type-section"><label for="label_rocketBank_bankList" class="line-title">은행선택</label>
										<div class="line-data">
										...
										<div class="validate-message" style="display: none;">은행을 선택해주세요</div></li>
								</ul>
							</div>
							<div class="pay-type-content" id="card">
								<ul class="pay-type-sections">
									<li class="pay-type-section"><label for="rocketCard-select" class="line-title">카드선택</label>
										...
										<div class="validate-message3">카드종류를 선택해주세요</div></li>
							...
							<div class="cellphone-payment pay-type-content" id="phone">
								<ul class="pay-type-sections">
									<li class="pay-type-section"><label for="cellphoneTelecom" class="payment-cellphone__line-title">통신사 종류</label>
										...
										<p class="payment-cellphone__validate-message">통신사 정보를 추가해주세요</p></li>
								</ul>
							</div>
							<div class="virtual-account-payment pay-type-content" id="virtual">
								<ul class="pay-type-sections">
									<li class="deposit-bank-wrap pay-type-section"><label for="depositBank" class="line-title">입금은행</label>
										...
										<div class="validate-message2" style="display: none;">은행을 선택해주세요</div></li>
									<li class="payBox-section  pay-type-section"><span class="line-title">입금기한</span>
										<div class="line-data">
											<span class="depositDueTxt">${depositDay}</span>
										</div></li>
